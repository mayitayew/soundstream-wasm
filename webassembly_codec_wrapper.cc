...
uint64_t EncodeBuffer(uintptr_t data, uint64_t num_samples, uint32_t sample_rate_hz, uint8_t* output) {
...
uint64_t DecodeBuffer(uint8_t *data, uint64_t num_samples, uint32_t sample_rate_hz, uintptr_t output) {
...
EMSCRIPTEN_BINDINGS(module) {
  ...
  emscripten::function("encodeAudioBuffer", EncodeBuffer, emscripten::allow_raw_pointers());
  emscripten::function("decodeAudioBuffer", DecodeBuffer, emscripten::allow_raw_pointers());
}